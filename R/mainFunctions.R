...
# fftwtools - fast Fourier transform
# ggplot2 - layered plots
# RColorBrewer - default colours
# sf - vector spatial data I/O and CRS handling
# terra - raster/vector operations and distance masking
...
#' @import RColorBrewer
#' @import viridis
#' @importFrom sf st_as_sf st_bbox st_crs st_geometry st_read st_transform
#' @importFrom terra crs distance ext project rast rasterize vect
